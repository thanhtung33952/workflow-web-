...
function TextareaProperties(props) {
  ...
  return (
    <div className={classes.propertiesRoot}>
      ...
      <div className={classes.row}>
        <span className={classes.label}>価値︓</span>
        <TextField
          value={valForm.value}
          variant="outlined"
          className={classNames(classes.fullControl, classes.control)}
      ...
      <div className={classes.row}>
        ...
        <TextField
          ...
          className={classNames(classes.fullControl, classes.control)}
          value={valForm.height}
          onChange={handleChangeTxt('height')}
        />
      </div>
      <div className={classes.row}>
...
// TextareaProperties.defaultProps = {
//   data: PropTypes.object
// };
