...
import { TextField, InputAdornment, FormControl, Select } from '@material-ui/core';
...
//components
// import SelectControl from 'components/CustomForm/Controls/SelectControl ';
...
function CheckboxProperties(props) {
  ...
  return (
    <div className={classes.propertiesRoot}>
      ...
      <div className={classes.row}>
        <span className={classes.label}>表示︓</span>
        <FormControl variant="outlined" className={classes.selectControl}>
          <Select
            native
            value={valForm.display}
            onChange={e =>
              setValForm({ ...valForm, display: e.target.value })
            }
          >
...
// CheckboxProperties.defaultProps = {
//   data: PropTypes.object
// };
