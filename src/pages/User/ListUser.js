...
export default function ListUser() {
  ...
  const deteleUser = async () => {
    ...
    // call api delete
    const result = await callAPIDeleteUser(userSelected.id);
    console.log(data);
    // Failed
    if (!result) {
  ...
  return (
    <div className={classes.root}>
      <Typography className={classes.titleTool}> ユーザー情報 </Typography>
      <Button
        variant="contained"
                ...
                >
                  <TableHead className={classes.headTable}>
                    <TableRow>
                      ...
                      <TableCell align="center">管理者機能権限</TableCell>
...
async function callAPIDeleteUser(id, data) {
